							...
							<?php if($mts_options['mts_single_headline_meta'] == '1') { ?>
								<div class="post-info">
									...
									<?php if(isset($mts_options['mts_single_headline_meta_info']['5']) == '1') { ?>
										<span class="thetime"><i class="icon-calendar"></i> <?php the_time( get_option( 'date_format' ) ); ?></span><span class="published" style="display: none;"><?php the_time('c'); ?></span><span class="updated" style="display: none;"><?php the_modified_date('c'); ?></span>
									<?php } ?>
										...
										<a rel="nofollow" class="relatedthumb" href="<?php the_permalink()?>" title="<?php the_title(); ?>">
											<span class="rthumb">
												<?php if(has_post_thumbnail()): ?>
													<?php the_post_thumbnail('featured3', 'title='); ?>
												<?php else: ?>
													<img src="<?php echo get_template_directory_uri(); ?>/images/relthumb-200x166.png" alt="<?php the_title(); ?>"  width='180' height='120' class="wp-post-image" />
												<?php endif; ?>
											</span>
							...
							<li class="<?php echo $postclass; ?> relatepostli<?php echo $li+$counter; ?>">
								<a rel="nofollow" class="relatedthumb" href="<?php the_permalink()?>" title="<?php the_title(); ?>">
									<span class="rthumb">
										...
										<?php else: ?>
											<img src="<?php echo get_template_directory_uri(); ?>/images/relthumb-140x100.png" alt="<?php the_title(); ?>"  width='180' height='120' class="wp-post-image" />
										<?php endif; ?>
									</span>
									<?php the_title(); ?>
								</a>
