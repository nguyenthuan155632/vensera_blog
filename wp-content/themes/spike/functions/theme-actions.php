...
<span><a href="<?php echo home_url(); ?>/" title="<?php bloginfo('description'); ?>" rel="nofollow"><?php bloginfo('name'); ?></a> <?php _e('Copyright','mythemeshop'); ?> &copy; <?php echo date("Y") ?>.</span>
<div class="top"><?php echo $mts_options['mts_copyrights']; ?> <a href="#top" class="toplink" rel="nofollow"><?php _e('Back to Top','mythemeshop'); ?></a></div>
</div>
<!--end copyrights-->
<?php }
}
