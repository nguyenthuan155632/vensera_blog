...
class Facebook_Like_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		if($page_url): ?>
			<div class="fb-like-box" data-href="<?php echo $page_url; ?>" data-height="<?php echo $height; ?>" data-width="<?php echo $width; ?>" data-colorscheme="<?php echo $color_scheme; ?>" data-show-faces="<?php echo $show_faces; ?>" data-header="<?php echo $show_header; ?>" data-stream="<?php echo $show_stream; ?>" ></div>
		<?php endif;
