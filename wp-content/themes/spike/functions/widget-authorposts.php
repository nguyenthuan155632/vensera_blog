...
class mts_author_posts_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if(is_singular()){
			...
			echo self::get_author_posts( $qty, $comment_num, $date, $show_thumb7, $show_excerpt, $excerpt_length, $thumb_size );
			echo $after_widget;
		}
	}

	public function get_author_posts( $qty, $comment_num, $date, $show_thumb7, $show_excerpt, $excerpt_length, $thumb_size ) {
	global $post;
	$thePostID = $post->ID;
	...
	$posts = new WP_Query( 
        ...
        $class = ($thumb_size == 'widgetthumb' ? '' : ' bigthumbs');
		echo '<ul class="author-posts-widget'.$class.'">';
