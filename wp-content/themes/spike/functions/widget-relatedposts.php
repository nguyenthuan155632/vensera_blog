...
class mts_related_posts_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if(is_singular()){
			...
			echo self::get_cat_posts( $qty, $comment_num, $date, $show_thumb6, $show_excerpt, $excerpt_length, $thumb_size );
			echo $after_widget;
		}
	}

	public function get_cat_posts( $qty, $comment_num, $date, $show_thumb6, $show_excerpt, $excerpt_length, $thumb_size ) {
	global $post;
	$thePostID = $post->ID;
	...
	foreach($cats as $individual_cat)
		...
		echo '<ul class="related-posts-widget'.$class.'">';
