						...
						<div class="font_options">
							<div class="left_col">
								<div class="collection_title_wrapper">
									<a href="#" class="button button-secondary collection_preview"><i class="icon icon-eye-open" style="margin-right: 2px;"></i> Preview</a>
								...
								<a href="#" class="button button-secondary collection_toggle_moreoptions"><i class="icon icon-cog" style="margin-right: 2px;"></i> More</a>
